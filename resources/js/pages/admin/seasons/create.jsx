...
export default function SeasonsCreate() {
    ...
    return (
        <AdminLayout>
            <Head title="Nouvelle Saison" />
            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-black uppercase italic text-dark">Nouvelle Saison</h1>
                    <p className="text-gray-600 mt-1">Créer une nouvelle saison sportive</p>
                </div>

                <Card>
                    <CardHeader>
                        <CardTitle>Informations de la saison</CardTitle>
                        <CardDescription>Remplissez les informations pour créer une nouvelle saison</CardDescription>
                    </CardHeader>
                    <CardContent>
