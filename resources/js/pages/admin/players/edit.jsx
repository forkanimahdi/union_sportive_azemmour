...
export default function PlayersEdit({ player, teams }) {
    ...
    return (
        <AdminLayout>
            <Head title={`Modifier ${player.first_name} ${player.last_name}`} />
            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-black uppercase italic text-dark">Modifier la Joueuse</h1>
                    <p className="text-gray-600 mt-1">{player.first_name} {player.last_name}</p>
                </div>

                <Card>
                    <CardHeader>
                        <CardTitle>Informations personnelles</CardTitle>
                        <CardDescription>Modifiez les informations de la joueuse</CardDescription>
                    </CardHeader>
                    <CardContent>
