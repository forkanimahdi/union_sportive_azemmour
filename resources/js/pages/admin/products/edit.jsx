...
export default function AdminProductsEdit({ product, categories }) {
    ...
    const imgUrl = (path) => path ? `/storage/${path}` : null;
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-4 border-t pt-4">
                                <Label className="text-base">Images (laisser vide pour conserver)</Label>
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        {(previewImage || product.image) && (
                                            <div className="w-20 h-20 rounded border overflow-hidden bg-muted">
                                                <img src={previewImage || imgUrl(product.image)} alt="" className="w-full h-full object-contain" />
                                            </div>
                                        )}
                                    </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        {(previewNoLogo || product.image_without_logo) && (
                                            <div className="w-20 h-20 rounded border overflow-hidden bg-muted">
                                                <img src={previewNoLogo || imgUrl(product.image_without_logo)} alt="" className="w-full h-full object-contain" />
                                            </div>
                                        )}
                                    </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        {(previewTshirt || product.image_customized_tshirt) && (
                                            <div className="w-20 h-20 rounded border overflow-hidden bg-muted">
                                                <img src={previewTshirt || imgUrl(product.image_customized_tshirt)} alt="" className="w-full h-full object-contain" />
                                            </div>
                                        )}
                                    </div>
