...
export default function AdminSponsorsCreate({ typeLabels }) {
        ...
        <AdminLayout>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold">Nouveau sponsor</h1>
                </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="flex gap-4 pt-4">
                                <Button type="submit">Créer le sponsor</Button>
