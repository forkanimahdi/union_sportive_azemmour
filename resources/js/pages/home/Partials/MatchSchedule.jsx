                                ...
                                >
                                    ...
                                    <div className="flex justify-between w-full items-center mb-4 gap-2">
                                        <div className="text-center flex-1">
                                            ...
                                            <span className="font-bold text-xs sm:text-sm break-words">{match.home_team}</span>
                                        </div>
                                        ...
                                        <div className="text-center flex-1">
                                            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-100 rounded-full mb-2 mx-auto"></div>
                                            <span className="font-bold text-xs sm:text-sm break-words">{match.away_team}</span>
                                        </div>
                                    </div>
