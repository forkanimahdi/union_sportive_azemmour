        ...
        <div className="py-16 sm:py-20 lg:py-24 bg-white text-dark">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative overflow-hidden">
                    ...
                    >
                        {matches.map((match) => (
                            <div key={match.id} className="min-w-[calc(100%-16px)] sm:min-w-[calc(50%-12px)] lg:min-w-[calc(33.333%-21.33px)] border border-gray-200 p-4 sm:p-6 flex flex-col items-center hover:shadow-xl transition-shadow group relative overflow-hidden bg-white">
                                ...
                                <div className="flex justify-between w-full items-center mb-4 gap-2">
                                    <div className="text-center flex-1">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-100 rounded-full mb-2 mx-auto"></div>
                                        <span className="font-bold text-xs sm:text-sm break-words">{match.home}</span>
                                    </div>
                                    ...
                                    <div className="text-center flex-1">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-100 rounded-full mb-2 mx-auto"></div>
                                        <span className="font-bold text-xs sm:text-sm break-words">{match.away}</span>
                                    </div>
                                </div>
