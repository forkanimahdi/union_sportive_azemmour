    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border: 1px solid #e5e5e5; border-radius: 8px; margin-bottom: 24px;">
        ...
        <tr>
            <td style="padding: 16px;">
                ...
                <p style="margin:0 0 8px 0;"><strong>Prix unitaire :</strong> {{ number_format($f['unit_price'], 0) }} DH</p>
                ...
                @include('emails.partials.order-financial-amounts', ['totalVerb' => 'régler'])
